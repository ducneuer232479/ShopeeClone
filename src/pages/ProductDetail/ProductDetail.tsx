          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative grid grid-cols-5 gap-1 mt-4'>
                <button className='absolute left-0 z-10 w-5 -translate-y-1/2 top-1/2 h-9 bg-black/20'>
                  <svg
                ...
                <button className='absolute right-0 z-10 w-5 -translate-y-1/2 top-1/2 h-9 bg-black/20'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
