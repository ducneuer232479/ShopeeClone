      ...
      <div className='flex flex-wrap items-center justify-between gap-2'>
        ...
        <div className='flex items-center'>
          ...
          <div className='flex items-center ml-2'>
            {page === 1 ? (
              <span className='flex items-center justify-center h-8 px-3 rounded-tl-sm rounded-bl-sm shadow cursor-not-allowed w-9 bg-white/60 hover:bg-slate-100'>
                <svg
              ...
              <Link
                className='flex items-center justify-center h-8 px-3 bg-white rounded-tl-sm rounded-bl-sm shadow w-9 hover:bg-slate-100'
                to={{
                  pathname: path.home,
                  search: createSearchParams({
                    ...queryConfig,
