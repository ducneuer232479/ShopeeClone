    ...
    <div className='px-3 py-4 bg-gray-300/40'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button className='h-8 px-4 text-sm text-center text-white capitalize h8 bg-orange hover:bg-orange/80'>
            Phổ biến
          </button>
          <button className='h-8 px-4 text-sm text-center text-black capitalize bg-white h8 hover:bg-slate-100'>
            Mới nhất
          </button>
          <button className='h-8 px-4 text-sm text-center text-black capitalize bg-white h8 hover:bg-slate-100'>
            Bán chạy
